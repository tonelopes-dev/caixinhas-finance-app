...
export const PremiumBadge = ({ className = "" }: PremiumBadgeProps) => {
  ...
  const overlayAnimations = [...Array(6).keys()].map((e) => (
    `
    @keyframes premiumOverlayAnimation${e + 1} {
      0% {
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 350 90" className="w-full h-auto min-w-[280px] sm:min-w-[320px] md:min-w-[350px] lg:min-w-[380px]">
          <defs>
            <linearGradient id="premiumBg" x1="0%" y1="0%" x2="100%" y2="100%">
              ...
              <stop offset="30%" stopColor="hsl(var(--accent))" stopOpacity="0.1" />
            ...
            <filter id="premiumShadow">
              <feDropShadow dx="0" dy="6" stdDeviation="12" floodColor="hsl(var(--primary))" floodOpacity="0.3"/>
            </filter>
            <mask id="premiumMask">
          ...
          {/* Background */}
          <rect width="350" height="90" rx="20" fill="url(#premiumBg)" filter="url(#premiumShadow)" />
          
          {/* Border */}
          <rect x="3" y="3" width="344" height="84" rx="17" fill="transparent" stroke="url(#premiumBorder)" strokeWidth="2" />
          ...
          >
            ...
            <tspan dx="6">Você é VIP Premium</tspan>
          </text>
          ...
          {/* Animated overlays */}
          <g style={{ mixBlendMode: "overlay" }} mask="url(#premiumMask)">
            <g style={{
              ...
              animation: disableOverlayAnimation ? "none" : "premiumOverlayAnimation1 6s infinite ease-in-out",
              willChange: "transform"
            }}>
              <polygon points="0,0 350,90 350,0 0,90" fill="hsl(var(--primary))" opacity="0.15" />
            </g>
            <g style={{
              transform: `rotate(${firstOverlayPosition + 20}deg)`,
              transformOrigin: "175px 45px",
              transition: !disableInOutOverlayAnimation ? "transform 300ms ease-out" : "none",
              animation: disableOverlayAnimation ? "none" : "premiumOverlayAnimation2 6s infinite ease-in-out",
              willChange: "transform"
            }}>
              <polygon points="0,0 350,90 350,0 0,90" fill="hsl(var(--accent))" opacity="0.15" />
            </g>
            <g style={{
              transform: `rotate(${firstOverlayPosition + 40}deg)`,
              transformOrigin: "175px 45px",
              transition: !disableInOutOverlayAnimation ? "transform 300ms ease-out" : "none",
              animation: disableOverlayAnimation ? "none" : "premiumOverlayAnimation3 6s infinite ease-in-out",
              willChange: "transform"
            }}>
            ...
            <g style={{
              ...
              transformOrigin: "175px 45px",
              transition: !disableInOutOverlayAnimation ? "transform 300ms ease-out" : "none",
              animation: disableOverlayAnimation ? "none" : "premiumOverlayAnimation4 6s infinite ease-in-out",
              willChange: "transform"
            }}>
              <polygon points="0,0 350,90 350,0 0,90" fill="hsl(var(--accent))" opacity="0.1" />
            </g>
            <g style={{
              transform: `rotate(${firstOverlayPosition + 80}deg)`,
              transformOrigin: "175px 45px",
              transition: !disableInOutOverlayAnimation ? "transform 300ms ease-out" : "none",
              animation: disableOverlayAnimation ? "none" : "premiumOverlayAnimation5 6s infinite ease-in-out",
              willChange: "transform"
            }}>
              <polygon points="0,0 350,90 350,0 0,90" fill="hsl(var(--primary))" opacity="0.13" />
            </g>
            <g style={{
              transform: `rotate(${firstOverlayPosition + 100}deg)`,
              transformOrigin: "175px 45px",
              transition: !disableInOutOverlayAnimation ? "transform 300ms ease-out" : "none",
              animation: disableOverlayAnimation ? "none" : "premiumOverlayAnimation6 6s infinite ease-in-out",
              willChange: "transform"
            }}>
              <polygon points="0,0 350,90 350,0 0,90" fill="hsl(var(--accent))" opacity="0.11" />
            </g>
          </g>
        </svg>
      </div>
