...
export default function NetWorthSummary({
  ...
  const PrivacyBlur = () => (
    <span className="text-3xl font-black tracking-tighter text-[#2D241E]/30">
      R$ ••••••
    </span>
  );
  const PrivacyBlurPrimary = () => (
    <span className="text-4xl font-black text-[#ff6b7b]/30 tracking-tighter">
      R$ ••••••
    </span>
  );
    ...
    <Card className="border-none bg-white shadow-[0_20px_50px_rgba(45,36,30,0.08)] rounded-[32px] overflow-hidden">
      <CardHeader className="pb-2">
        <div className="flex items-start justify-between gap-4">
          <div className="space-y-1 min-w-0 flex-1">
            ...
            <CardDescription className="text-xs sm:text-base font-medium text-[#2D241E]/50">
      ...
      <CardContent>
        <Link
          ...
          className="relative group block rounded-3xl bg-[#f6f3f1] p-4 sm:p-8 transition-all duration-300 hover:shadow-inner border border-[#2D241E]/5 mb-8 overflow-hidden"
        >
          ...
          <div className="relative group flex items-center gap-6 rounded-[28px] bg-white border-2 border-[#f6f3f1] p-6 transition-all duration-300 hover:border-[#ff6b7b]/20 hover:shadow-lg">
            ...
            <div className="space-y-0.5">
              ...
              {!isLoaded || isPrivate ? (
                ...
                <p className="text-3xl font-bold tracking-tighter text-[#2D241E]">
                  <AnimatedCounter
                    value={liquidAssets}
                    formatter={formatCurrency}
                  />
