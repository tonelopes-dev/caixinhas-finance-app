...
export function Hero() {
  ...
  return (
    <section id="hero" className="container grid items-center gap-12 py-20 lg:grid-cols-2 lg:py-24">
      <div className="space-y-6 text-center lg:text-left">
        <h1 className="font-sans text-5xl font-bold leading-tight tracking-tighter md:text-7xl">
