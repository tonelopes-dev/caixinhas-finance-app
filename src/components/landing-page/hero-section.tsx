...
function PhotoCarousel() {
  const allImages = [
    ...
    "https://images.unsplash.com/photo-1497436072909-60f360e1d4b1?w=900&auto=format&fit=crop&q=60",
              ...
              <div className="flex items-center gap-4">
                <div className="flex -space-x-4">
                  <Avatar className="h-12 w-12 border-2 border-background">
                    <AvatarImage
                      src="https://images.unsplash.com/photo-1554151228-14d9def656e4?w=100"
                  ...
                  <Avatar className="h-12 w-12 border-2 border-background">
                    <AvatarImage
                      src="https://images.unsplash.com/photo-1552058544-f2b08422138a?w=100"
                  ...
                  <Avatar className="h-12 w-12 border-2 border-background">
                    <AvatarImage
                      src="https://images.unsplash.com/photo-1499952127939-9bbf5af6c51c?w=100"
                  ...
                  <Avatar className="h-12 w-12 border-2 border-background">
                    <AvatarImage
                      src="https://images.unsplash.com/photo-1544723795-3fb6469f5b39?w=100"
