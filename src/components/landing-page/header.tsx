...
export function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#fdfcf7]/70 backdrop-blur-xl border-b border-stone-200/50 transition-all duration-300 shadow-sm">
      <div className="container mx-auto h-20 px-6 flex items-center justify-between">
        <div className="flex items-center gap-3 group cursor-pointer">
          <Image
            ...
            height={44}
            quality={100}
            className="w-11 h-11 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-6"
          />
      ...
      <div
        className={`lg:hidden absolute top-20 left-0 right-0 bg-[#fdfcf7]/80 backdrop-blur-xl border-b border-stone-200/50 transition-all duration-300 ease-in-out w-full shadow-xl ${
          isMobileMenuOpen
