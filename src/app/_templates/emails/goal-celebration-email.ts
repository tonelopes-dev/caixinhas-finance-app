...
export const goalCelebrationEmail = (
  ...
  <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:0 0 24px 0;">
    <tr>
      <td style="background:linear-gradient(135deg,#d4af37 0%,#e8c84a 50%,#c49a2a 100%);border-radius:14px;padding:24px;text-align:center;">
  ...
  ${infoBox('💡 <strong>Próximo passo:</strong> Que tal definir uma nova meta ainda mais ousada? Continue construindo seu futuro financeiro!')}
